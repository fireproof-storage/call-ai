...
describe("Vision Model Tests", () => {
  ...
  itif(Boolean(haveApiKey))(
    ...
    async () => {
      console.log(
        "Note: This test is just to verify vision model integration using description",
      );
      console.log(
        "Image generation requires direct OpenAI API access with DALL-E models",
      );
      ...
      try {
        ...
        console.log(
          "Note: This test may fail if the specific vision model isn't available through your API key",
        );
  ...
  it("provides information about DALL-E integration", () => {
    ...
    console.log(
      "4. Documentation: https://platform.openai.com/docs/api-reference/images",
    );
