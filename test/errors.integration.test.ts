...
describe("Error handling integration tests", () => {
  ...
  itif(!!haveApiKey)("should reproduce the JSON parsing error seen in streaming mode", async () => {
    try {
  ...
  itif(!!haveApiKey)("should mimic React app error handling with streaming", async () => {
  ...
  itif(!!haveApiKey)("should explore AsyncGenerator error handling patterns", async () => {
